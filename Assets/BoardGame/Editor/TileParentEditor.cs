...
namespace BoardGame.Editor {
    ...
    public class TileParentEditor : UnityEditor.Editor {
        ...
        private float CheckboxWidth => 120;
        ...
        private Vector2Int DrawVec2Int(string label, Vector2Int oldValue) {
            ...
            // var newX = EditorGUILayout.IntField("X", oldValue.x);
            // var newY = EditorGUILayout.IntField("Y", oldValue.y);
            // var newValue = new Vector2Int(newX, newY);
            // EditorGUIUtility.labelWidth = oldWidth;
            // EditorGUILayout.EndHorizontal();
            // return newValue;
        }
            ...
            if (EditorGUI.EndChangeCheck()) {
                if (startPoint) {
                    ...
                    if (allTiles.Count > 0) {
                        ...
                        Undo.RecordObject(lastTile, "Set 'start point'");
